...
namespace GLFW
{
    ...
    public class NativeWindow : SafeHandleZeroOrMinusOneIsInvalid, IEquatable<NativeWindow>
    {
        ...
        private void BindCallbacks()
        {
            ...
            mouseButtonCallback = (_, button, state, mod) => MouseButtonCallback(_, button, state, mod);
        ...
        //private event MouseButtonCallback _mouseButtonCallback;
        /// <summary>
        ...
        private unsafe void MouseButtonCallback(Window window, MouseButton button, InputState action, ModifierKeys mods)
        {
            try
            {
