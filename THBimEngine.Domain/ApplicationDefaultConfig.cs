...
namespace THBimEngine.Domain
{
    public class ApplicationDefaultConfig
    {
        ...
        {
            new SourceConfig(EApplcationName.CAD,"主体","CAD"){ FileExt =new List<string>{ ".dwg"},LinkFileExt =new List<string>{ ".thbim",".ifc"} },
            new SourceConfig(EApplcationName.SU,"SU","SU") { FileExt =new List<string>{ ".skp"},LinkFileExt =new List<string>{ ".thbim",".ifc"} },
