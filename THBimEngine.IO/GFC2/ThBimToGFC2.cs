...
namespace THBimEngine.IO.GFC2
{
    ...
    {
        public static int ToGfc(this THBimProject prj, ThGFC2Document gfcDoc, ref int globalId)
        {
        ...
        public static int ToGfc(this THBimBuilding building, ThGFC2Document gfcDoc, ref int globalId)
        {
        ...
        public static int ToGfc(this THBimStorey storey, ThGFC2Document gfcDoc, ref int globalId)
        {
        ...
        /// <returns></returns>
        public static int ToGfc(this THBimWall wall, ThGFC2Document gfcDoc, XbimMatrix3D floorHightMatrix, ref int globalId, ref Dictionary<int, Tuple<int, List<int>>> entityModel)
        {
            var id = -1;
            ...
            if (hasModel == false)
            {
                var modelId = wall.ToGfcWallModel(gfcDoc, ref globalId, leftWidth, width);
            ...
            id = ToGfcWall(gfcDoc, wall.Material, shapeId, leftWidth, width, btmElevS, topElevS, ref globalId);
        ...
        public static int ToGfcWallModel(this THBimWall wall, ThGFC2Document gfcDoc, ref int globalId, double leftWidth, int width)
        {
            var id = ToGfcWall(gfcDoc, wall.Material, -1, leftWidth, width, "层底标高", "层顶标高", ref globalId);
            return id;
        }

        public static int ToGfcWall(ThGFC2Document gfcDoc, string material, int shapeId, double leftWidth, int width, string btmElev, string topElev, ref int globalId)
        {
