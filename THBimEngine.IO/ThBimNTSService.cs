...
{
    public class ThBimNTSService
    {
        //==============SINGLETON============
        //fourth version from:
        //http://csharpindepth.com/Articles/General/Singleton.aspx
        private static readonly ThBimNTSService instance = new ThBimNTSService() { PrecisionReduce = false };
        // Explicit static constructor to tell C# compiler
        // not to mark type as beforefieldinit    
        static ThBimNTSService() { }
        internal ThBimNTSService() { }
        public static ThBimNTSService Instance { get { return instance; } }
        //-------------SINGLETON-----------------
