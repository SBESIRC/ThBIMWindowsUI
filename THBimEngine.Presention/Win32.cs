...
namespace THBimEngine.Presention
{
	...
	public static class Win32
    {
        ...
        public static bool SetWindowBackground(IntPtr hwnd, uint LWA_ALPHA) 
        {
            return SetLayeredWindowAttributes(hwnd, 100, 128, LWA_ALPHA);
        }
        const int WM_CLOSE = 0x0010;
        public static void CloseRender(IntPtr winHander)
        {
            SendMessage(winHander, WM_CLOSE, IntPtr.Zero, IntPtr.Zero);
        }
        #endregion
    }
}
